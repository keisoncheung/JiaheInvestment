...
<body>
    ...
    <div class="menu">
      ...
      <div lang="MainMenu" style="background-image: url(bgpic/Admin_left_02.gif); line-height: 25px;"
            ...
            <span style="cursor: hand">&nbsp;集团新闻<span lang="zh-cn"></span> <span style="color: #ff0000">
                √</span></span>
        </div>
        <div class="menuContent">
            <ul>
               <li><a href="news.aspx?type=54" target="main">新闻列表</a></li>
                <li><a href="newsshow.aspx?type=54" target="main">新闻列表</a></li>
            </ul>
        </div>
        
         <div lang="MainMenu" style="background-image: url(bgpic/Admin_left_02.gif); line-height: 25px;"
            class="menu_title" onmouseover="this.className='menu_title5';" onmouseout="this.className='menu_title';">
            <span style="cursor: hand">&nbsp;行业新闻<span lang="zh-cn"></span> <span style="color: #ff0000">
                √</span></span>
        </div>
        <div class="menuContent">
            <ul>
        ...
        <div lang="MainMenu" style="background-image: url(bgpic/Admin_left_02.gif); line-height: 25px;"
            class="menu_title" onmouseover="this.className='menu_title5';" onmouseout="this.className='menu_title';">
            <span style="cursor: hand">&nbsp;集团项目<span lang="zh-cn"></span> <span style="color: #ff0000">
                √</span></span>
        </div>
        <div class="menuContent">
            <ul>
               
                <li><a href="proshow.aspx?lan=1" target="main">项目列表</a></li>
                <li><a href="protype.aspx" target="main">项目类别</a></li>
            </ul>
        </div>
